...
var GraphicsDefinition = (function () {
  ...
  var def = {
    ...
    draw: function(ctx, clip, ratio, colorTransform) {
      ...
      // Stuff below doesn't seem to work with normal Kanvas either.
      if (!this._canvas) {
